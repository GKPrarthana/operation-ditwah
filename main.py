...
#     - Base Score: 5
#     - +2 if Age > 60 or < 5
#     - +3 if Need is "Rescue" (Life Threat)
#     - +1 if Need is "Insulin/Medicine"
...
#     TASK: Explore 3 branches to maximize priority score saved in shortest time:
...
from core.classifier import process_messages
from core.logistics import run_commander
from core.stability import run_stability_experiment
from core.budget import run_budget_demo
from core.pipeline import run_news_pipeline

dotenv.load_dotenv()

def main():
    print("=== CRISIS RESPONSE SYSTEM ===")
    
    print("\n Part 1: Classification (Few-Shot)")
    process_messages(r"data/Sample Messages.txt")
    
    print("\n Part 2: Stability Experiment (Temperature Stress Test)")
    run_stability_experiment()
    
    print("\n Part 3: Logistics Commander (CoT & ToT)")
    run_commander("data/incidents.txt")
    
    print("\n Part 4: Budget Keeper (Token Economics)")
    run_budget_demo()
